...
impl Default for VoxSimple {
    fn default() -> Self { VoxSimple("armor.empty".to_string()) }
}

#[derive(Deserialize)]
struct VoxMirror(String, bool);

impl Default for VoxMirror {
    fn default() -> Self { VoxMirror("armor.empty".to_string(), false) }
}
        ...
        [
            third_person.map(|_| {
                spec.head.read().0.mesh_head(
                    ...
                    spec.armor_head
                        .read()
                        .0
                        .load_head(body, loadout.head.as_deref()),
                )
            }),
            third_person.map(|loadout| {
                spec.armor_chest
                    .read()
                    .0
                    .mesh_chest(body, color, loadout.chest.as_deref())
            }),
            third_person.map(|loadout| {
                spec.armor_belt
                    .read()
                    .0
                    .mesh_belt(body, color, loadout.belt.as_deref())
            }),
            third_person.map(|loadout| {
                spec.armor_back
                    .read()
                    .0
                    .mesh_back(body, color, loadout.back.as_deref())
            }),
            third_person.map(|loadout| {
                spec.armor_pants
                    .read()
            ...
            Some(spec.armor_glider.read().0.mesh_glider(body, color, glider)),
            tool.and_then(|tool| tool.active.as_ref())
                .map(|tool| spec.main_weapon.read().0.mesh_main_weapon(tool, false)),
            tool.and_then(|tool| tool.second.as_ref())
                .map(|tool| spec.main_weapon.read().0.mesh_main_weapon(tool, true)),
            Some(
                spec.armor_lantern
                    .read()
                    .0
                    .mesh_lantern(body, color, lantern),
            ),
            Some(mesh_hold()),
        ]
    },
...
make_vox_spec!(
    ...
    |FigureKey { body, extra, .. }, spec| {
        let third_person = extra
            .as_ref()
            .and_then(|loadout| loadout.third_person.as_ref());
        ...
        [
            ...
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_foot_fl(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_foot_fr(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_foot_bl(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_foot_br(body.species, body.body_type),
            ),
            Some(
                spec.central
                    .read()
        ...
        [
            ...
            third_person.map(|_| {
                spec.central
                    .read()
                    .0
                    .mesh_neck(body.species, body.body_type)
            }),
            third_person.map(|_| spec.central.read().0.mesh_jaw(body.species, body.body_type)),
            Some(
                spec.central
                    .read()
                    .0
            ...
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_torso_front(body.species, body.body_type),
            ),
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_torso_back(body.species, body.body_type),
            ),
            third_person.map(|_| {
                spec.central
                    .read()
            ...
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_leg_fl(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_leg_fr(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_leg_bl(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_leg_br(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
        ...
        [
            ...
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_wing_in_l(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_wing_in_r(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_wing_out_l(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_wing_out_r(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
        ...
        [
            ...
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_chest_front(body.species, body.body_type),
            ),
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_chest_back(body.species, body.body_type),
            ),
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_tail_front(body.species, body.body_type),
            ),
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_tail_back(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
        ...
        [
            ...
            third_person.map(|_| {
                spec.lateral
                    .read()
                    .0
                    .mesh_mandible_l(body.species, body.body_type)
            }),
            third_person.map(|_| {
                spec.lateral
                    .read()
                    .0
                    .mesh_mandible_r(body.species, body.body_type)
            }),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_wing_fl(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_wing_fr(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_wing_bl(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_wing_br(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
            ...
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_leg_fcl(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_leg_fcr(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_leg_bcl(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_leg_bcr(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
        ...
        [
            ...
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_tail_f(body.species, body.body_type),
            ),
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_tail_b(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_arm_l(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_pincer_l0(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_pincer_l1(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_arm_r(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_pincer_r0(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_pincer_r1(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
            ...
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_leg_cl(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
            ...
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_leg_cr(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
...
impl CrustaceanLateralSpec {
    fn mesh_arm_l(&self, species: CSpecies, body_type: CBodyType) -> BoneMeshes {
        ...
        let lateral = graceful_load_segment_flipped(
            &spec.arm_l.lateral.0,
            spec.arm_l.lateral.1,
            spec.arm_l.model_index,
        );
    ...
    fn mesh_arm_r(&self, species: CSpecies, body_type: CBodyType) -> BoneMeshes {
        ...
        let lateral = graceful_load_segment_flipped(
            &spec.arm_r.lateral.0,
            spec.arm_r.lateral.1,
            spec.arm_r.model_index,
        );
    ...
    fn mesh_pincer_r0(&self, species: CSpecies, body_type: CBodyType) -> BoneMeshes {
        ...
        let lateral = graceful_load_segment_flipped(
            &spec.pincer_r0.lateral.0,
            spec.pincer_r0.lateral.1,
            spec.pincer_r0.model_index,
        );
    ...
    fn mesh_pincer_r1(&self, species: CSpecies, body_type: CBodyType) -> BoneMeshes {
        ...
        let lateral = graceful_load_segment_flipped(
            &spec.pincer_r1.lateral.0,
            spec.pincer_r1.lateral.1,
            spec.pincer_r1.model_index,
        );
    ...
    fn mesh_leg_fl(&self, species: CSpecies, body_type: CBodyType) -> BoneMeshes {
        ...
        let lateral = graceful_load_segment_flipped(
            &spec.leg_fl.lateral.0,
            spec.leg_fl.lateral.1,
            spec.leg_fl.model_index,
        );
    ...
    fn mesh_leg_cl(&self, species: CSpecies, body_type: CBodyType) -> BoneMeshes {
        ...
        let lateral = graceful_load_segment_flipped(
            &spec.leg_cl.lateral.0,
            spec.leg_cl.lateral.1,
            spec.leg_cl.model_index,
        );
    ...
    fn mesh_leg_bl(&self, species: CSpecies, body_type: CBodyType) -> BoneMeshes {
        ...
        let lateral = graceful_load_segment_flipped(
            &spec.leg_bl.lateral.0,
            spec.leg_bl.lateral.1,
            spec.leg_bl.model_index,
        );
    ...
    fn mesh_leg_fr(&self, species: CSpecies, body_type: CBodyType) -> BoneMeshes {
        ...
        let lateral = graceful_load_segment_flipped(
            &spec.leg_fr.lateral.0,
            spec.leg_fr.lateral.1,
            spec.leg_fr.model_index,
        );
    ...
    fn mesh_leg_cr(&self, species: CSpecies, body_type: CBodyType) -> BoneMeshes {
        ...
        let lateral = graceful_load_segment_flipped(
            &spec.leg_cr.lateral.0,
            spec.leg_cr.lateral.1,
            spec.leg_cr.model_index,
        );
    ...
    fn mesh_leg_br(&self, species: CSpecies, body_type: CBodyType) -> BoneMeshes {
        ...
        let lateral = graceful_load_segment_flipped(
            &spec.leg_br.lateral.0,
            spec.leg_br.lateral.1,
            spec.leg_br.model_index,
        );
...
make_vox_spec!(
    ...
    |FigureKey { body, extra, .. }, spec| {
        ...
        [
            ...
            Some(spec.central.read().0.mesh_jaw(body.species, body.body_type)),
            Some(
                spec.central
                    .read()
                    .0
            ...
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_fin_l(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_fin_r(body.species, body.body_type),
            ),
            None,
            None,
            None,
...
make_vox_spec!(
    ...
    |FigureKey {
     ...
     spec| {
        ...
        [
            third_person.map(|loadout| spec.armor_head.read().0.mesh_head(loadout.head.as_deref())),
            third_person.map(|loadout| {
                spec.armor_chest
                    .read()
                    .0
                    .mesh_chest(loadout.chest.as_deref())
            }),
            third_person.map(|loadout| {
                spec.armor_pants
                    .read()
                    .0
                    .mesh_pants(loadout.pants.as_deref())
            }),
        ...
        [
            ...
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_chest_rear(body.species, body.body_type),
            ),
            Some(
                spec.central
                    .read()
            ...
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_tail_rear(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
        ...
        [
            ...
            third_person.map(|_| {
                spec.central
                    .read()
                    .0
                    .mesh_beak(body.species, body.body_type)
            }),
            Some(
                spec.central
                    .read()
            ...
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_wing_mid_l(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_wing_mid_r(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
    ...
    |FigureKey {
     ...
     spec| {
        ...
        [
            ...
            tool.and_then(|tool| tool.active.as_ref())
                .map(|tool| spec.main.read().0.mesh_main(tool, false)),
            tool.and_then(|tool| tool.active.as_ref())
                .map(|tool| spec.second.read().0.mesh_second(tool, false)),
            Some(
                spec.lateral
                    .read()
                    .0
...
struct SidedQLLateralVoxSpec {
    left_upper: QuadrupedLowLateralSubSpec,
    left_lower: QuadrupedLowLateralSubSpec,
    left_jaw: QuadrupedLowLateralSubSpec,
    right_upper: QuadrupedLowLateralSubSpec,
    right_lower: QuadrupedLowLateralSubSpec,
    right_jaw: QuadrupedLowLateralSubSpec,
        ...
        [
            ...
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_left_head_upper(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_left_head_lower(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_left_jaw(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_right_head_upper(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_right_head_lower(body.species, body.body_type),
            ),
            Some(
                spec.lateral
                    .read()
                    .0
                    .mesh_right_jaw(body.species, body.body_type),
            ),
            Some(
                spec.central
                    .read()
...
impl QuadrupedLowLateralSpec {
    fn mesh_left_head_upper(&self, species: QLSpecies, body_type: QLBodyType) -> BoneMeshes {
        let spec = match self.0.get(&(species, body_type)) {
            Some(spec) => spec,
            None => {
                error!(
                    "No left upper head specification exists for the combination of {:?} and {:?}",
                    species, body_type
                );
                return load_mesh("not_found", Vec3::new(-5.0, -5.0, -2.5));
            },
        ...
        let latspec = &spec.left_upper.lateral;
        let lateral =
            graceful_load_segment_flipped(&latspec.0, latspec.1, spec.left_upper.model_index);

        (lateral, Vec3::from(spec.left_upper.offset))
    }

    fn mesh_left_head_lower(&self, species: QLSpecies, body_type: QLBodyType) -> BoneMeshes {
        let spec = match self.0.get(&(species, body_type)) {
            Some(spec) => spec,
            None => {
                error!(
                    "No left lower head specification exists for the combination of {:?} and {:?}",
                    species, body_type
                );
                return load_mesh("not_found", Vec3::new(-5.0, -5.0, -2.5));
            },
        ...
        let latspec = &spec.left_lower.lateral;
        let lateral =
            graceful_load_segment_flipped(&latspec.0, latspec.1, spec.left_lower.model_index);

        (lateral, Vec3::from(spec.left_lower.offset))
    }

    fn mesh_left_jaw(&self, species: QLSpecies, body_type: QLBodyType) -> BoneMeshes {
        let spec = match self.0.get(&(species, body_type)) {
            Some(spec) => spec,
            None => {
                error!(
                    "No left jaw specification exists for the combination of {:?} and {:?}",
                    species, body_type
                );
                return load_mesh("not_found", Vec3::new(-5.0, -5.0, -2.5));
            },
        ...
        let latspec = &spec.left_jaw.lateral;
        let lateral =
            graceful_load_segment_flipped(&latspec.0, latspec.1, spec.left_jaw.model_index);

        (lateral, Vec3::from(spec.left_jaw.offset))
    }

    fn mesh_right_head_upper(&self, species: QLSpecies, body_type: QLBodyType) -> BoneMeshes {
        let spec = match self.0.get(&(species, body_type)) {
            Some(spec) => spec,
            None => {
                error!(
                    "No right upper head specification exists for the combination of {:?} and {:?}",
                    species, body_type
                );
                return load_mesh("not_found", Vec3::new(-5.0, -5.0, -2.5));
            },
        ...
        let latspec = &spec.right_upper.lateral;
        let lateral =
            graceful_load_segment_flipped(&latspec.0, latspec.1, spec.right_upper.model_index);

        (lateral, Vec3::from(spec.right_upper.offset))
    }

    fn mesh_right_head_lower(&self, species: QLSpecies, body_type: QLBodyType) -> BoneMeshes {
        let spec = match self.0.get(&(species, body_type)) {
            Some(spec) => spec,
            None => {
                error!(
                    "No right lower head specification exists for the combination of {:?} and {:?}",
                    species, body_type
                );
                return load_mesh("not_found", Vec3::new(-5.0, -5.0, -2.5));
            },
        ...
        let latspec = &spec.right_lower.lateral;
        let lateral =
            graceful_load_segment_flipped(&latspec.0, latspec.1, spec.right_lower.model_index);

        (lateral, Vec3::from(spec.right_lower.offset))
    }

    fn mesh_right_jaw(&self, species: QLSpecies, body_type: QLBodyType) -> BoneMeshes {
        let spec = match self.0.get(&(species, body_type)) {
            Some(spec) => spec,
            None => {
                error!(
                    "No right jaw specification exists for the combination of {:?} and {:?}",
                    species, body_type
                );
                return load_mesh("not_found", Vec3::new(-5.0, -5.0, -2.5));
            },
        ...
        let latspec = &spec.right_jaw.lateral;
        let lateral =
            graceful_load_segment_flipped(&latspec.0, latspec.1, spec.right_jaw.model_index);

        (lateral, Vec3::from(spec.right_jaw.offset))
    }
...
make_vox_spec!(
    ...
    |FigureKey { body, .. }, spec| {
        [
            Some(spec.central.read().0.mesh_bone0(body)),
            Some(spec.central.read().0.mesh_bone1(body)),
            None,
            None,
            None,
            None,
        ...
        [
            Some(
                spec.central
                    .read()
                    .0
                    .mesh_bone0(body, item_key.as_deref().unwrap_or(&ItemKey::Empty)),
            ),
            None,
            None,
            None,
