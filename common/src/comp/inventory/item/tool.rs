...
// `ToolKind` et `Hands` sont dans `common-vocab` : `comp::body::item::Body`
// porte un `ToolKind` en charge utile de variante, ce qui etait la seule
// dependance de structure entre les corps et les objets.
pub use common_vocab::outils::{Hands, ToolKind};
