...
///
/// ```
/// veloren_common_vocab::make_case_elim!(
///     my_type_module,
///     #[repr(u32)]
///     #[derive(Clone,Copy)]
///     pub enum MyType {
...
///     impl<T> PackedElim for veloren_common_vocab::typed::Pure<T> {
///         type Constr1 = T;
///         type Constr2 = T;
///     }
///
...
///     pub type PureCases<Elim> = Cases<veloren_common_vocab::typed::Pure<Elim>>;
/// }
/// ```
///
