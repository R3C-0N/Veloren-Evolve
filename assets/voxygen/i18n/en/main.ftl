...
main-login-network_wrong_version = Mismatched server and client version. Hint: You might need to update your game client or contact server owner for update.
