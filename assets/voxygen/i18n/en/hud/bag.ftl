...
hud-bag-ingredients-tab = Ingredients
hud-bag-quest-items-tab = Quest Items
hud-bag-armor = Armor
hud-bag-stats = Stats
hud-bag-head = Head
hud-bag-neck = Neck
...
hud-bag-outil_pioche = Pickaxe
hud-bag-outil_hache = Axe
hud-bag-outil_pelle = Shovel
...
hud-bag-toggle-expanded-window = Toggle expanded window
