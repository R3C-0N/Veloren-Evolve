...
command-site-desc = Teleportera till ett ställe
...
command-kick-desc = Sparka en spelare med givet användarnamn
command-lantern-desc = Ändra din lyktas styrka och färg
command-light-desc = Spawna entitet med ljus
command-lightning-desc = Blixtnedslag vid nuvarande position
command-location-desc = Teleportera till en plats
command-make_block-desc = Gör ett block på din plats med en färg
command-motd-desc = Se serverbeskrivningen
command-object-desc = Spawna ett objekt
command-outcome-desc = Skapa ett utfall
command-players-desc = Lista spelare som är online
command-portal-desc = Spawnar en portal
command-region-desc = Skickar meddelanden till alla i din region i världen
command-remove_lights-desc = Rensar alla ljus spawnade av spelare
command-repair_equipment-desc = Reparerar alla utrustade föremål
command-reset_recipes-desc = Nollställer din receptbok
command-respawn-desc = Teleportera till din vägpunkt
command-safezone-desc = Skapar en säker zon
command-set_motd-desc = Sätt serverbeskrivningen
command-message-group-missing =
    Du använder gruppchatt men tillhör ingen grupp. Använd /world eller
    /region för att ändra chatt.
command-waypoint-error = Kunde ej hitta din vägpunkt.
command-player-info-unavailable = Kan ej hämta spelarinformation för { $target }
command-kit-inventory-unavailable = Kunde ej hämta packning
command-inventory-cant-fit-item = Kan ej få plats med föremålet i packning
command-entity-has-no-client = Spelare har ingen klientkomponent: { $target }
command-death_effect-unknown = Okänd dödseffekt { $effect }.
command-outcome-invalid_outcome = { $outcome } är ej ett giltigt utfall
command-site-not-found = Ställe inte hittad
command-time_scale-changed = Sätt tidsskalan till { $scale }.
command-time_scale-current = Nuvarande tidsskala är { $scale }.
command-faction-join = Vänligen gå med i en fraktion med /join_faction
command-group_invite-invited-to-your-group = { $player } har blivit inbjuden till din grupp.
command-into_npc-warning = Jag hoppas att du inte missbrukar det här!
command-adminify-cannot-find-player = Kan ej hitta spelarentitet!
command-adminify-already-has-role = Spelare har redan den rollen!
command-adminify-already-has-no-role = Spelare har redan ingen roll!
command-adminify-role-downgraded = Roll för spelare { $player } sänkt till { $role }
command-adminify-role-upgraded = Roll för spelare { $player } höjt till { $role }
command-adminify-removed-role = Roll borttagen från spelare { $player }: { $role }
command-weather-valid-values = Giltiga värden är ”clear”, ”rain”, ”wind” och ”storm”.
command-scale-set = Sätt skalan till { $scale }
command-repaired-items = Reparerade alla utrustade föremål
command-repaired-inventory_items = Reparerade alla föremål
command-set-waypoint-result = Vägpunkt satt!
command-preprocess-not-looking-at-valid-target = Tittar inte på ett giltigt mål
command-preprocess-not-selected-valid-target = Väljer inte ett giltigt mål
